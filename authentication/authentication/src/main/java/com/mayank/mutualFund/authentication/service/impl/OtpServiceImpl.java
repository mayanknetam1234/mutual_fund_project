...
import com.mayank.mutualFund.authentication.service.producer.EmailTopicProducer;
...
public class OtpServiceImpl implements OtpService {
    ...
    private final EmailTopicProducer emailTopicProducer;

    public OtpServiceImpl(UserRepository userRepository, EmailTopicProducer emailTopicProducer) {

        this.userRepository = userRepository;
        this.emailTopicProducer = emailTopicProducer;
    }
    ...
    public void sendOtp(String email, String otp) throws RuntimeException{
        ...
        String htmlMessage = "<html>"
          ...
          emailTopicProducer.publishMessage(email,subject,htmlMessage);
